...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("canabalt", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("canabalt", null, 960, 320);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "4";
		app.meta["company"] = "Finji";
		app.meta["file"] = "canabalt";
		app.meta["name"] = "Canabalt";
	...
	macro public static function getPreloader()
	{
		...
		var type = Context.getType("source.Preloader");
		...
		return macro
		{
			new openfl.display.Preloader(new source.Preloader());
		}
